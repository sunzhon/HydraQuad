...
#define CAN_IOCTL_COMMAND      __DIOT(_DCMD_CHR,ADVCAN_IOC_MAGIC + 1,Command_par_t)   /**< IOCTL command request */
#define CAN_IOCTL_CONFIG       __DIOT(_DCMD_CHR,ADVCAN_IOC_MAGIC + 2,Config_par_t)    /**< IOCTL configuration request */
#define CAN_IOCTL_SEND         __DIOT(_DCMD_CHR,ADVCAN_IOC_MAGIC + 3,int)             /**< IOCTL request */
#define CAN_IOCTL_RECEIVE      __DIOT(_DCMD_CHR,ADVCAN_IOC_MAGIC + 4,int)             /**< IOCTL request */
#define CAN_IOCTL_CONFIGURERTR __DIOT(_DCMD_CHR,ADVCAN_IOC_MAGIC + 5,int)             /**< IOCTL request */
#define CAN_IOCTL_STATUS       __DIOTF(_DCMD_CHR,ADVCAN_IOC_MAGIC + 6,CanStatusPar_t)             /**< IOCTL status request */
